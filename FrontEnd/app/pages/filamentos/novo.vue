  ...
  <div>
    ...
    <div class="split-layout" style="grid-template-columns:minmax(0,1fr) 330px">
      <form @submit.prevent="save(false)">
        <div class="form-card">
          <h2 class="form-card__title"><UiIcon name="spool" />1. Informações do Filamento</h2>
          <div class="form-grid">
            ...
            <div class="field col-4" data-field="type" :class="{'field--error':errors.type}"><label>Tipo / Diâmetro *</label><select v-model="form.type"><option>1.75 mm</option><option>2.85 mm</option><option>Outro</option></select><small v-if="errors.type" class="field__error">{{errors.type}}</small></div>
      ...
      <aside>
        ...
        <PanelCard title="Custo por Grama" style="margin-top:12px">
          ...
          <div class="field" style="margin-top:12px"><label>Quanto custa uma peça?</label><input v-model.number="pieceWeight" type="number"></div>
