...
const { filaments, deleteItem } = useAppData()
      ...
      <PanelCard>
        <div class="table-scroll">
          <table class="data-table">
            ...
            <tbody>
              <tr v-for="(f,i) in filaments" :key="f.id || f.name" :class="{selected:selectedIndex===i}" @click="selectedIndex=i">
                <td><input type="radio" :checked="selectedIndex===i"></td>
        ...
        <div class="table-footer"><span>Mostrando 1 a {{filaments.length}} de {{filaments.length}} filamentos</span><div class="pagination"><button class="page-btn active">1</button></div></div>
      </PanelCard>
      <aside>
