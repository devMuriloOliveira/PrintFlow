...
<template>
  <div>
    ...
    <PageHeader :title="isEditing ? 'Editar Meta' : 'Nova Meta'" :subtitle="isEditing ? 'Atualize objetivo, periodo e valor esperado.' : 'Crie uma nova meta e acompanhe a evolucao do seu negocio.'" />
    <div class="split-layout" style="grid-template-columns:minmax(0,1fr) 330px">
      <form @submit.prevent="save">
        ...
        <div class="form-actions"><button class="btn" type="button" @click="cancel">Cancelar</button><button class="btn btn--primary" type="submit" :disabled="saving">{{ saving ? 'Salvando...' : isEditing ? 'Salvar Alteracoes' : 'Criar Meta' }}</button></div>
      </form>
