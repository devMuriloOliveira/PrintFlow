...
const form = reactive({ name: '', sku: '', category: 'Decoracao', description: '', status: 'Ativo', printer: '', filament: '', weight: 0, hours: 0, minutes: 0, layer: .2, infill: 20, packaging: 0, materials: 0, labor: 0, energy: true, marketplaceFee: 0, price: 0, desiredMargin: 40 })
