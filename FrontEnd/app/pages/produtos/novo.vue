...
const { products, createProduct, updateItem } = useAppData()
const { notify } = useUi()
...
const hydrateForm = (product: any) => {
  ...
  Object.assign(form, {
    ...
    layer: Number(product.layer || .2),
    infill: Number(product.infill || 20),
