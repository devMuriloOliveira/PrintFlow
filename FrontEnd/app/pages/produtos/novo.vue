...
const form = reactive({ name: '', sku: '', category: 'Decoração', description: '', status: 'Ativo', printerId: '', filamentId: '', weight: 0, hours: 0, minutes: 0, packaging: 0, materials: 0, labor: 0, energy: true, shopeeFee: 0, otherMarketplaceFee: 0, marketplaceFee: 0, otherCosts: 0, price: 0, desiredMargin: 40 })
