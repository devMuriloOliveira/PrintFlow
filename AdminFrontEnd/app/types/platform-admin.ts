...
export type PlatformPlan = { id: string; code: string; name: string; description: string; monthlyReferencePrice: number; yearlyReferencePrice: number; stripeProductId: string; stripeMonthlyPriceId: string; stripeYearlyPriceId: string; trialDays: number; limits: Record<string, number>; features: Record<string, boolean>; active: boolean; createdAt: string; updatedAt?: string }
