...
const filteredRequests = computed(() => {
  ...
  return requests.value.filter(request => {
    ...
    const content = `${request.id} ${request.subject} ${request.reason} ${request.category} ${request.requestedBy} ${request.status} ${tenantFor(request.tenantId)?.name || request.tenantId}`.toLowerCase()
