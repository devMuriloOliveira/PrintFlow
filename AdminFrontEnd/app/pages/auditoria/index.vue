...
<template>
  <AdminShell v-model:search="search" title="Auditoria" subtitle="Acompanhe acessos e acoes administrativas" :request-count="activeRequests.length">
    ...
    <section class="audit-guide" aria-label="Tipos de auditoria"><article><strong>1. Atividade da plataforma</strong><span>Exporta acoes administrativas dos superadmins.</span></article><article><strong>2. Historico de atendimento</strong><span>Gera o registro de um protocolo especifico.</span></article><article><strong>3. Dados de uma empresa</strong><span>Exige autorizacao aprovada e acesso temporario.</span></article></section>
