...
const actionLabels = {
  ...
  'platform.support.metadata_updated': 'Dados operacionais do suporte atualizados',
  'platform.support.bulk_updated': 'Atendimentos atualizados em lote',
  'platform.support.attachment_added': 'Anexo de suporte adicionado',
  'platform.support.reopened': 'Atendimento de suporte reaberto',
  'platform.support.snoozed': 'Atendimento de suporte adiado',
  'platform.support.auto_assigned': 'Atendimentos distribuidos automaticamente',
  'platform.support.sla_rule_updated': 'Regra de SLA de suporte atualizada',
  ...
  'orders.stage_advanced': 'Etapa do pedido atualizada',
  'subscription.deadline_transition': 'Assinatura atualizada pelo prazo',
  'subscription.deadline_warning': 'Prazo da assinatura proximo',
  ...
  'support.request.attachment_added': 'Anexo de suporte adicionado',
  'support.request.reopened': 'Solicitacao de suporte reaberta pelo cliente',
