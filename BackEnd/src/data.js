export const db = {
  ...
  orders: [
    { id: '#10845', date: '31/05/2024', client: 'Cliente 001', marketplace: 'Shopee', product: 'Vaso Geometrico', qty: 2, gross: 160, fee: 22.4, shipping: 18, net: 119, profit: 70.2, status: 'Novo' },
    { id: '#10844', date: '31/05/2024', client: 'Cliente 002', marketplace: 'Mercado Livre', product: 'Suporte para Fone', qty: 1, gross: 89.9, fee: 13.49, shipping: 15, net: 61.41, profit: 35.1, status: 'Producao' },
    { id: '#10843', date: '30/05/2024', client: 'Cliente 003', marketplace: 'Elo7', product: 'Flexi Dinossauro', qty: 1, gross: 69.9, fee: 8.39, shipping: 12, net: 49.51, profit: 29.4, status: 'Impresso' },
    { id: '#10842', date: '30/05/2024', client: 'Cliente 004', marketplace: 'Shopee', product: 'Porta Treco Modular', qty: 2, gross: 120, fee: 16.8, shipping: 18, net: 85.2, profit: 51, status: 'Embalando' },
    { id: '#10841', date: '29/05/2024', client: 'Cliente 005', marketplace: 'Mercado Livre', product: 'Chaveiro Personalizado', qty: 3, gross: 60, fee: 9, shipping: 10, net: 41, profit: 24.6, status: 'Enviado' },
    { id: '#10840', date: '29/05/2024', client: 'Cliente 006', marketplace: 'Amazon', product: 'Vaso Cachepot', qty: 1, gross: 99.9, fee: 14.99, shipping: 15, net: 69.91, profit: 39.8, status: 'Entregue' },
    { id: '#10839', date: '28/05/2024', client: 'Cliente 007', marketplace: 'Instagram', product: 'Kit Miniaturas RPG', qty: 1, gross: 129.9, fee: 0, shipping: 20, net: 109.9, profit: 63.5, status: 'Entregue' },
    { id: '#10838', date: '27/05/2024', client: 'Cliente 008', marketplace: 'Elo7', product: 'Luminaria Lua 3D', qty: 1, gross: 149.9, fee: 17.99, shipping: 18, net: 113.91, profit: 65.3, status: 'Entregue' },
    { id: '#10837', date: '26/05/2024', client: 'Cliente 009', marketplace: 'Shopee', product: 'Suporte para Controle', qty: 2, gross: 70, fee: 9.8, shipping: 15, net: 45.2, profit: 26.8, status: 'Cancelado' },
    { id: '#10836', date: '25/05/2024', client: 'Cliente 010', marketplace: 'Mercado Livre', product: 'Organizador de Mesa', qty: 1, gross: 59.9, fee: 8.99, shipping: 12, net: 38.91, profit: 22.1, status: 'Entregue' }
  ],
  expenses: [
  ...
  printers: [
    { name: 'Ender 3 V2', code: 'PRT-001', maker: 'Creality', model: 'Ender 3 V2', acquired: '15/06/2022', power: 350, hours: 412, status: 'Em Impressao', maintenance: '28/04/2024', serial: 'SERIAL-DEMO-001' },
    { name: 'Prusa i3 MK3', code: 'PRT-002', maker: 'Prusa Research', model: 'Prusa i3 MK3S+', acquired: '10/03/2022', power: 210, hours: 638, status: 'Disponivel', maintenance: '18/04/2024', serial: 'SERIAL-DEMO-002' },
    { name: 'Bambu Lab P1P', code: 'PRT-003', maker: 'Bambu Lab', model: 'P1P', acquired: '22/11/2023', power: 350, hours: 156, status: 'Disponivel', maintenance: '10/05/2024', serial: 'SERIAL-DEMO-003' },
    { name: 'Neptune 4', code: 'PRT-004', maker: 'Elegoo', model: 'Neptune 4', acquired: '05/01/2024', power: 500, hours: 189, status: 'Em Impressao', maintenance: '02/05/2024', serial: 'SERIAL-DEMO-004' },
    { name: 'Sermoon D3', code: 'PRT-005', maker: 'Creality', model: 'D3', acquired: '20/08/2023', power: 420, hours: 83, status: 'Em Manutencao', maintenance: '11/05/2024', serial: 'SERIAL-DEMO-005' },
    { name: 'Anycubic Kobra 2', code: 'PRT-006', maker: 'Anycubic', model: 'Kobra 2', acquired: '12/07/2023', power: 400, hours: 98, status: 'Disponivel', maintenance: '01/05/2024', serial: 'SERIAL-DEMO-006' }
  ],
  marketplaces: [
    ...
    { name: 'TikTok Shop', short: 'T', color: '#111827', commission: 5, fixed: 0.5, financial: 4.49, ads: 5, others: 1, gross: 3940, net: 2120, orders: 73, active: true },
    { name: 'Site Proprio', short: 'S', color: '#1768f2', commission: 0, fixed: 0, financial: 2.99, ads: 0, others: 0.5, gross: 2980, net: 2720, orders: 51, active: true }
  ],
  clients: [
    { name: 'Cliente 001', email: 'nao-informado', phone: 'nao-informado', orders: 14, revenue: 1890.4, ticket: 135.03, last: '31/05/2024' },
    { name: 'Cliente 002', email: 'nao-informado', phone: 'nao-informado', orders: 9, revenue: 1128.7, ticket: 125.41, last: '31/05/2024' },
    { name: 'Cliente 003', email: 'nao-informado', phone: 'nao-informado', orders: 7, revenue: 840.5, ticket: 120.07, last: '30/05/2024' },
    { name: 'Cliente 004', email: 'nao-informado', phone: 'nao-informado', orders: 11, revenue: 1440, ticket: 130.91, last: '30/05/2024' },
    { name: 'Cliente 005', email: 'nao-informado', phone: 'nao-informado', orders: 5, revenue: 550.8, ticket: 110.16, last: '29/05/2024' }
  ],
  expenseSegments: [
    { label: 'Filamento', value: 36.7, color: '#1768f2' },
    { label: 'Marketplaces', value: 29.4, color: '#29b6c8' },
    { label: 'Embalagens', value: 8.8, color: '#f59e0b' },
    { label: 'Energia', value: 12.7, color: '#fb923c' },
    { label: 'Marketing', value: 6.7, color: '#c83bb7' },
